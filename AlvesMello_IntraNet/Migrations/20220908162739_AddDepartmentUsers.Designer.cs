...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlvesMello_IntraNet.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("TelephoneExtension")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlvesMello_IntraNet.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AlvesMello_IntraNet.Models.FavoriteUserSite", b =>
                {
                    ...
                    b.Property<string>("FavoriteSiteId")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("AlvesMello_IntraNet.Models.ApplicationUser", b =>
                {
                    b.HasOne("AlvesMello_IntraNet.Models.Department", null)
                        .WithMany("Users")
            ...
            modelBuilder.Entity("AlvesMello_IntraNet.Models.Site", b =>
                {
                    b.HasOne("AlvesMello_IntraNet.Models.Department", "Department")
                        .WithMany("Sites")
                        .HasForeignKey("DepartmentId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AlvesMello_IntraNet.Models.ApplicationUser", null)
                        .WithMany()
